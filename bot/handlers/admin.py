...
_HELP_TEXT = (
    ...
    "🖼 <b>Poster display</b>\n"
    "▫️ <code>/postermode photo</code> — tapped title opens a full poster "
    "card\n"
    "▫️ <code>/postermode thumb</code> — tapped title stays text with a "
    "small poster preview\n\n"
    "😎 <b>Fun voice</b>\n"
    "▫️ <code>/funmode on</code> — genz voice (roasts, hype, reactions, "
    "easter eggs)\n"
    "▫️ <code>/funmode off</code> — plain default voice\n\n"
    "💎 <b>Premium</b>\n"
